export 'data/repositories/product_details_impl.dart';
...
export 'data/models/product_details.dart';

export 'domain/entities/product_details.dart';
export 'domain/repositories/product_details.dart';
...
export 'presentation/pages/product_details.dart';
