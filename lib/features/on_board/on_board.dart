export 'data/repositories/on_board_impl.dart';
export 'data/datasources/remote.dart';
export 'data/datasources/remote_impl.dart';
export 'data/models/on_board.dart';

export 'domain/entities/on_board.dart';
export 'domain/repositories/on_board.dart';
...
export 'presentation/pages/onboard.dart';
export 'presentation/widgets/dots.dart';
